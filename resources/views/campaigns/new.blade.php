                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" checked="1" value="1" class="form-check-input">
                                    Activated Campaign
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <textarea name="campaign_description" id="campaign_description" cols="30" rows="10" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
