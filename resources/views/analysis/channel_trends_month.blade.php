...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Monthly Channel Trends </li>
    </ol>
    </nav>
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">
                  Monthly <span class="badge badge-light"> {{ $channel_name}}</span> channel trends for <span class="badge badge-secondary">{{ $selected_year}}</span>
                </h4>
            </div>
            <div class="card-body">
                <div id="chart"></div>
        ...
        <div class="card" style="margin-top: 20px;">
          <div class="card-header">
              <h4 class="card-title">
                Monthly <span class="badge badge-light"> {{ $channel_name}}</span> trend analysis for <span class="badge badge-secondary">{{ $selected_year}}</span>
              </h4>
          </div>
          <div class="card-body">
...
var options = {
  ...
  xaxis: {
    categories: [@foreach($channel as $row){{ $row->month }},@endforeach]
  },
  stroke: {
      width: 3,
      curve: "smooth", 
